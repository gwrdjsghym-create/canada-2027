...
<section class="section montreal-evenings" aria-labelledby="montreal-evenings-title">
  ...
  <div class="evening-grid">
    ...
    <article><span class="evening-number">02</span><p class="idea-place">Samstag · Erlebnisabend</p><h3>Ein buchbares Highlight</h3><p>AURA, Twilight Walk, Ghost Walk, Grande Roue oder eine geführte Nachttour. Das Ergebnis der Abstimmung entscheidet, ob vorher früh gegessen wird.</p><a class="evening-cta" href="idea.php?id=montreal-evening">Abendideen ansehen &amp; bewerten →</a></article>
...
<nav class="mobile-nav"><a href="index.php"><span>⌁</span>Reise</a><a class="active" href="#ideas"><span>★</span>Ideen</a><a href="index.php#travellers"><span>♙</span>Wir vier</a></nav><dialog id="details-dialog"><button class="close-dialog" aria-label="Schließen">×</button><div id="dialog-content"></div></dialog><script src="app.js?v=20260906-2"></script></body></html>
