...
<nav class="mobile-nav"><a href="index.php"><span>⌁</span>Reise</a><a href="abstimmungen.php"><span>★</span>Abstimmen</a><a class="active" href="#ideas"><span>＋</span>Ideen</a></nav><dialog id="details-dialog"><button class="close-dialog" aria-label="Schließen">×</button><div id="dialog-content"></div></dialog><script src="app.js?v=20260909-1"></script></body></html>
